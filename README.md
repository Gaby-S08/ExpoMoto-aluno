...
O **ExpoMoto** é uma Landing Page moderna e responsiva desenvolvida com foco em **SEO (Search Engine Optimization)** e boas práticas de Front-end. O projeto simula a página de uma loja de compra de motos, apresentando marcas, peças e novidades.
...
├── explicacao.md    # explicaçao do código realizado
├── Layout_motos.jpg # Layout do site
